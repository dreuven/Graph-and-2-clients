...
public class TraversalTesting {
    ...
    public void traversalTest() {
        ...
        assertTrue(Arrays.equals(poss1VisDFS, actualArrVisDFS)
                || Arrays.equals(poss2VisDFS, actualArrVisDFS));
        assertTrue(Arrays.equals(poss1PosVisDFS, actualArrPosVisDFS)
                || Arrays.equals(poss2PosVisDFS, actualArrPosVisDFS));
        assertTrue(Arrays.equals(poss1VisBFS, actualArrVisBFS)
                || Arrays.equals(poss2VisBFS, actualArrVisBFS)
                || Arrays.equals(poss3VisBFS, actualArrVisBFS)
                || Arrays.equals(poss4VisBFS, actualArrVisBFS));
    }
}
