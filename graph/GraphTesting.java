...
public class GraphTesting {
    ...
    public void edgeIdUndirected() {
        ...
        g.add(3, 3);
        g.add(3, 1);
        assertEquals(g.edgeId(1, 3), g.edgeId(3, 1));
        assertEquals(g.edgeId(3, 3), g.edgeId(3, 3));
    ...
    @Test
    public void testUndirectedEdgesAutoGrad() {
        UndirectedGraph g = new UndirectedGraph();
        g.add();
        g.add();
        g.add();
    ...
    @Test
    public void testDirectedAfterRemoveCount() {
        DirectedGraph g = new DirectedGraph();
        g.add();
        g.add();
        g.add();
    ...
    @Test
    public void testIncomingDirectedHavoc() {
        DirectedGraph g = new DirectedGraph();
        g.add();
        g.add();
        g.add();
    ...
    @Test
    public void testUndirectedIncomingHavoc() {
        UndirectedGraph g = new UndirectedGraph();
        g.add();
        g.add();
        g.add();
    ...
    @Test
    public void testUndirectedIncomingHavocEdgeRemove() {
        UndirectedGraph g = new UndirectedGraph();
        g.add();
        g.add();
        g.add();
    ...
    @Test
    public void testDirectedIncomingHavocEdgeRemove() {
        DirectedGraph g = new DirectedGraph();
        g.add();
        g.add();
        g.add();
    ...
    @Test
    public void testUndirectedSelfEdgesAutoGradConseq() {
        UndirectedGraph g = new UndirectedGraph();
        g.add();
        g.add();
        g.add();
    ...
    @Test
    public void directedPredAfterRemove() {
        DirectedGraph g = new DirectedGraph();
        g.add();
        g.add();
        g.add();
    ...
    @Test
    public void numEdgesUndirected() {
        UndirectedGraph g = new UndirectedGraph();
        g.add();
        g.add(1, 1);
        assertEquals(1, g.edgeSize());
